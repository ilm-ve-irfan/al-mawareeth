...
type FormContextValue = {
  ...
  addHeir: (heir: { relation: HeirRelation; name: string; isUnborn?: boolean; motherId?: string }) => void;
...
export function FormProvider({ children }: { children: ReactNode }) {
  ...
  const addHeir = useCallback(
    (heir: { relation: HeirRelation; name: string; isUnborn?: boolean; motherId?: string }) => {
      setData((prev) => ({
        ...prev,
